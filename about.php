...
<head>
    ...
    <link rel="stylesheet" href="css/abt1.css">
...
<div class="header2 text-white text-center position-relative"> 
    <div class="d-flex justify-content-center align-items-center"><h1 class="fw-bold">Infos-Sure-Nous</h1></div>
</div>
<div class="container bg-light pt-5 pb-5">
  <div class="row ">

    <div class="col-lg-6 text-end st">
        <img src="images/abtx.jpg" class="w-75 rounded opacity-75" style="height:10cm">
    </div>
  ...
  <div class="row ">
    ...
    <div class="col-lg-6 position-relative ">
          <div class="w-75 p-1 m-0 ndp">
            <h1 class="fw-bold">Notre Vision</h1>
            <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem praesentium atque quaerat magni eos dicta nulla quidem
              dolorum ipsum quibusdam minus et aperiam suscipit unde fugit, voluptatum enim eaque exercitationem!</p>
          </div>
    </div>
    <div class="col-lg-6 text-start nd">
        <img src="images/abty.jpg" class="w-75 rounded " style="height:10cm">
    </div>
  </div>
</div>
